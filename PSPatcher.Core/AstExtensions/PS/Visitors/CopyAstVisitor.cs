...
{
    public abstract class CopyAstVisitor : ICustomAstVisitor
    {
        protected readonly PSScriptAst rootAst;

        protected CopyAstVisitor(PSScriptAst rootAst)
        {
        ...
        public virtual object VisitNamedBlock(NamedBlockAst namedBlockAst)
        {
            ...
            var newStatements = VisitElements(namedBlockAst.Statements);
            var statementBlock = new StatementBlockAst(namedBlockAst.Extent, newStatements, newTraps);
            return new NamedBlockAst(namedBlockAst.Extent, namedBlockAst.BlockKind, statementBlock,
        ...
        {
            var newStatements = VisitElements(statementBlockAst.Statements);
        ...
        {
            return new TrapStatementAst(trapStatementAst.Extent, VisitElement(trapStatementAst.TrapType),
        ...
        public virtual object VisitAttribute(AttributeAst attributeAst)
        {
            ...
            return new AttributeAst(attributeAst.Extent, attributeAst.TypeName, newPositionalArguments,
                newNamedArguments);
        }
        ...
        {
            var newAst = new StringConstantExpressionAst(stringConstantExpressionAst.Extent, stringConstantExpressionAst.Value,
                stringConstantExpressionAst.StringConstantType);
            
            if (rootAst.ModifiedAsts.Contains(stringConstantExpressionAst))
        ...
        {
            return new VariableExpressionAst(variableExpressionAst.Extent, variableExpressionAst.VariablePath,
        ...
        public virtual object VisitInvokeMemberExpression(InvokeMemberExpressionAst invokeMemberExpressionAst)
        {
            ...
            var newAst = new InvokeMemberExpressionAst(invokeMemberExpressionAst.Extent, newExpression, newMethod,
                newArguments, invokeMemberExpressionAst.Static);
            if (rootAst.ModifiedAsts.Contains(invokeMemberExpressionAst))
                rootAst.ModifiedAsts.Add(newAst);
